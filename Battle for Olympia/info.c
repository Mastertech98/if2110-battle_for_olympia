		...
		for (j=0;j<=3;j++){
			...
			for(k=1;k<=Kolom*4;k++){
				if(j == 0){
					...
					if((k-2)%4 ==0){
						if(j == 1){
							if(GetColor(*GetOwner(*GetGrid(Kolom-1,Baris-1))) == 'R'){
								if(GetType(*GetGrid(Kolom-1,Baris-1)) == Tower){
									print_red('T');
								} else if(GetType(*GetGrid(Kolom-1,Baris-1)) == Castle){
									print_red('C');
								} else if(GetType(*GetGrid(Kolom-1,Baris-1)) == Village){
									print_red('V');
								}
							} else if(GetColor(*GetOwner(*GetGrid(Kolom-1,Baris-1))) == 'G'){
								if(GetType(*GetGrid(Kolom-1,Baris-1)) == Tower){
									print_green('T');
								} else if(GetType(*GetGrid(Kolom-1,Baris-1)) == Castle){
									print_green('C');
							...
							} else if(GetColor(*GetOwner(*GetGrid(Kolom-1,Baris-1))) == 'Y'){
								if(GetType(*GetGrid(Kolom-1,Baris-1)) == Tower){
									print_yellow('T');
								} else if(GetType(*GetGrid(Kolom-1,Baris-1)) == Castle){
									print_yellow('C');
							...
							} else if(GetColor(*GetOwner(*GetGrid(Kolom-1,Baris-1))) == 'B'){
								if(GetType(*GetGrid(Kolom-1,Baris-1)) == Tower){
									print_blue('T');
								} else if(GetType(*GetGrid(Kolom-1,Baris-1)) == Castle){
									print_blue('C');
							...
							} else if(GetColor(*GetOwner(*GetGrid(Kolom-1,Baris-1))) == 'M'){
								if(GetType(*GetGrid(Kolom-1,Baris-1)) == Tower){
									print_magenta('T');
								} else if(GetType(*GetGrid(Kolom-1,Baris-1)) == Castle){
									print_magenta('C');
							...
							} else if(GetColor(*GetOwner(*GetGrid(Kolom-1,Baris-1))) == 'C'){
								if(GetType(*GetGrid(Kolom-1,Baris-1)) == Tower){
									print_cyan('T');
								} else if(GetType(*GetGrid(Kolom-1,Baris-1)) == Castle){
									print_cyan('C');
								...
								if(GetType(*GetGrid(Kolom-1,Baris-1)) == Village){
									printf("V");
								}
							}
						} else if(j==2){
							if(GetUnitColor(*GetUnit(*GetGrid(Kolom-1,Baris-1))) == 'R'){
								if(GetUnitColor(*GetUnit(*GetGrid(Kolom-1,Baris-1))) == King){
									print_red('K');
								} else if(GetUnitColor(*GetUnit(*GetGrid(Kolom-1,Baris-1))) == Archer){
									print_red('A');
								} else if(GetUnitColor(*GetUnit(*GetGrid(Kolom-1,Baris-1))) == Swordsman){
									print_red('S');
								} else if(GetUnitColor(*GetUnit(*GetGrid(Kolom-1,Baris-1))) == WhiteMage){
									print_red('W');
								}
							} else if(GetUnitColor(*GetUnit(*GetGrid(Kolom-1,Baris-1))) == 'G'){
								if(GetUnitColor(*GetUnit(*GetGrid(Kolom-1,Baris-1))) == King){
									print_green('K');
								} else if(GetUnitColor(*GetUnit(*GetGrid(Kolom-1,Baris-1))) == Archer){
									print_green('A');
							...
							} else if(GetUnitColor(*GetUnit(*GetGrid(Kolom-1,Baris-1))) == 'Y'){
								if(GetUnitColor(*GetUnit(*GetGrid(Kolom-1,Baris-1))) == King){
									print_yellow('K');
								} else if(GetUnitColor(*GetUnit(*GetGrid(Kolom-1,Baris-1))) == Archer){
									print_yellow('A');
							...
							} else if(GetUnitColor(*GetUnit(*GetGrid(Kolom-1,Baris-1))) == 'B'){
								if(GetUnitColor(*GetUnit(*GetGrid(Kolom-1,Baris-1))) == King){
									print_blue('K');
								} else if(GetUnitColor(*GetUnit(*GetGrid(Kolom-1,Baris-1))) == Archer){
									print_blue('A');
							...
							} else if(GetUnitColor(*GetUnit(*GetGrid(Kolom-1,Baris-1))) == 'M'){
								if(GetUnitColor(*GetUnit(*GetGrid(Kolom-1,Baris-1))) == King){
									print_magenta('K');
								} else if(GetUnitColor(*GetUnit(*GetGrid(Kolom-1,Baris-1))) == Archer){
									print_magenta('A');
							...
							} else if(GetUnitColor(*GetUnit(*GetGrid(Kolom-1,Baris-1))) == 'C'){
								if(GetUnitColor(*GetUnit(*GetGrid(Kolom-1,Baris-1))) == King){
									print_cyan('K');
								} else if(GetUnitColor(*GetUnit(*GetGrid(Kolom-1,Baris-1))) == Archer){
									print_cyan('A');
