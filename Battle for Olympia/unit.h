...
typedef enum AttackType {Melee, Ranged} AttackType;
...
typedef struct Unit {
    ...
    POINT location;
    int price;
    int probabilityExposedToAttack;
} Unit;
...
int GetProbabilityExposedToAttack(Unit unit);
/* Mengembalikan probability exposed to attack dari unit */
